...
import { accumulateClassifiedRows, } from "../core/transcript.js";
...
export function summarizeHermesConversation(conversationHistory) {
    const records = [];
...
function classifyHermesMessage(record) {
