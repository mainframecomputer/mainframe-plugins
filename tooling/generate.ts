...
// `skills.external_dirs` — see README.md). Hermes ships no stop hook: it has no
// hook event that fires when the agent stops and can re-engage it, so unlike
// Cursor/Codex/Claude there is nothing for the host-agnostic stop runtime to
// drive.
